...
{
    public class RadRespuestas6B2Configuration : IEntityTypeConfiguration<RadRespuestas6B2>
    {
        public void Configure(EntityTypeBuilder<RadRespuestas6B2> builder)
        {
            builder.ToTable("rad__respuestas_6_b2");
            ...
            builder.Property(e => e.SeExporta).HasColumnName("se_exporta");
            ...
            builder.HasOne(d => d.IdEstadoNavigation)
                .WithMany(p => p.RadRespuestas6B2)
                .HasForeignKey(d => d.IdEstado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("rad__respuestas_6_b2_id_estado_foreign");

            builder.HasOne(d => d.IdGrupoNavigation)
                .WithMany(p => p.RadRespuestas6B2)
                .HasForeignKey(d => d.IdGrupo)
                .HasConstraintName("rad__respuestas_6_b2_id_grupo_foreign");

            builder.HasOne(d => d.IdOrganizacionNavigation)
                .WithMany(p => p.RadRespuestas6B2)
                .HasForeignKey(d => d.IdOrganizacion)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("rad__respuestas_6_b2_id_organizacion_foreign");

            builder.HasOne(d => d.IdProductoNavigation)
                .WithMany(p => p.RadRespuestas6B2)
                .HasForeignKey(d => d.IdProducto)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("rad__respuestas_6_b2_id_producto_foreign");

            builder.HasOne(d => d.IdRadiografiaNavigation)
                .WithMany(p => p.RadRespuestas6B2)
                .HasForeignKey(d => d.IdRadiografia)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("rad__respuestas_6_b2_id_radiografia_foreign");
        }
    }
}
