...
namespace RadiografiaEmpresarial.Api.Controllers
{
    ...
    [Authorize]
    [ApiController]
    public class ConfigPaisesController : ControllerBase
    {
        private readonly IUnitOfWork _unitOfWork;
        public ConfigPaisesController(IUnitOfWork unitOfWork)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("*********\n** Controlador: PaisesController\n** Accion: /\n** GET");
            var paises = _unitOfWork.PaisesRepository.GetAll();
            var response = new ApiResponse<IEnumerable<ConfigPaises>>(paises);
            return Ok(response);
        }
    }
}
