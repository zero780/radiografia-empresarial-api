...
{
    public partial class RadRespuestas4C : BaseEntity
    {
        ...
        public long? IdSuministroAgua { get; set; }
        public double? HorasParadas { get; set; }
        public bool? NecesidadTratamiento { get; set; }
        public string TipoTratamiento { get; set; }
        public double? CostoTratamiento { get; set; }
        ...
        public virtual TipoSuministros IdSuministroAguaNavigation { get; set; }
    }
}
