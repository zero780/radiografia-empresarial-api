...
{
    public partial class CoreGrupos : BaseEntity
    {
        public CoreGrupos()
        {
        ...
        public virtual EstadoGrupos IdEstadoNavigation { get; set; }
        public virtual CoreOrganizaciones IdOrganizacionNavigation { get; set; }
        public virtual AuthUsuarios IdSupervisadorNavigation { get; set; }
