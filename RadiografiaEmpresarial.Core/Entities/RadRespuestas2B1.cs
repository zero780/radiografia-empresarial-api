...
{
    public partial class RadRespuestas2B1 : BaseEntity
    {
        ...
        public virtual TipoCiius IdActividadNavigation { get; set; }
        ...
        public virtual TipoCpcs IdProductoNavigation { get; set; }
