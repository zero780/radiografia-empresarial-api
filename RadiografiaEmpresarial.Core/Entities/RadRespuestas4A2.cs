...
{
    public partial class RadRespuestas4A2 : BaseEntity
    {
        ...
        public bool? NecesarioAgrupar { get; set; }
        public double Fiabilidad { get; set; }
        ...
        public virtual TipoFrecuencias IdFrecuenciaNavigation { get; set; }
